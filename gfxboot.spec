#
# spec file for package gfxboot (Version 3.1.0)
#
...
# neededforbuild  docbook-xsl-stylesheets docbook_4 libgcrypt libgpg-error libxml2 libxslt nasm sgml-skel w3m x-devel-packages xmlto

BuildRequires: aaa_base acl attr bash bind-utils bison bzip2 coreutils cpio cpp cracklib cvs cyrus-sasl db devs diffutils e2fsprogs file filesystem fillup findutils flex gawk gdbm-devel gettext-devel glibc glibc-devel glibc-locale gpm grep groff gzip info insserv klogd less libacl libattr libcom_err libgcc libnscd libselinux libstdc++ libxcrypt libzio m4 make man mktemp module-init-tools ncurses ncurses-devel net-tools netcfg openldap2-client openssl pam pam-modules patch permissions popt procinfo procps psmisc pwdutils rcs readline sed strace sysvinit tar tcpd texinfo timezone unzip util-linux vim zlib zlib-devel autoconf automake binutils docbook-xsl-stylesheets docbook_4 expat fontconfig fontconfig-devel gcc gdbm gettext libgcrypt libgpg-error libtool libxml2 libxslt nasm perl rpm sgml-skel w3m xmlto xorg-x11-devel xorg-x11-libs
